...
--Step 2 Now assign each item a price, using UPDATE - item 1 should be 10 dollars, item 2 should be 20 dollars, item 3 should be 30 dollars. 
...
-- Step 3 now insert a new item into the table that has all three attributes filled in, including 'price'. 
-- Do one final SELECT of all the rows to check it worked.

INSERT INTO clothes (type,design,price) VALUES("jacket", "blue and white strips",20);
